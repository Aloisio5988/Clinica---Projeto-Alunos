						...
						<div class="col-md-12 col-sm-12 ">
								...
								<div class="x_content">
									...
									<form action="paciente.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Profissional:<span class="required">*</span>
											</label>
											<div class="col-md-2 col-sm-2 ">
												<input type="text" id="last-name" name="last-name"  required="required" class="form-control">
											</div>
										
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Especialidade:<span class="required">*</span></label>
											<div class="col-md-3 col-sm-3 ">
											<input id="name" class="form-control" type="text" name="text">
											</div>
										</div>
											...
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button type="reset" name="reset" class="btn btn-outline-info">Limpar</button>
