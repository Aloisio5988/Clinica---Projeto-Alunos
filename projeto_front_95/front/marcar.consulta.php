						...
						<div class="col-md-12 col-sm-12 ">
								...
								<div class="x_content">
									...
									<form action="paciente.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Consulta:<span class="required">*</span>
											</label>
                                        ...
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="data">Data: <span class="required">*</span>
											...
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" name="submit" class="btn btn-outline-info">Verificar</button>
											</div>
											</div>
